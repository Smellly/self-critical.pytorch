...
import eval_utils_viz as eval_utils
import argparse
...
print(modeldict['att_embed.0.weight'].shape)
print(modeldict['att_embed.0.bias'].shape)
np.save('vc2att_w', modeldict['core.vcAttention.vc2att.weight'].numpy())
np.save('vc2att_b', modeldict['core.vcAttention.vc2att.bias'].numpy())
# print(modeldict['core.h2att_v.weight'])
# print(modeldict['core.h2att_v.weight'].shape)
# exit()
model.cuda()
model.eval()
