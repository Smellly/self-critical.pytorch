...
def get_self_critical_reward(model, fc_feats, att_feats, scene_feats, att_masks, data, gen_result, opt):
    ...
    model.eval()
    with torch.no_grad():
        greedy_res, _ = model(fc_feats, att_feats, scene_feats, att_masks=att_masks, mode='sample')
    model.train()
